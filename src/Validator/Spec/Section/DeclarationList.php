        ...
        $this->declarationList = [
            0 => [
                    ...
                    'declaration' => [
                        ...
                        ['name' => 'pointer-events'],
                        ['name' => 'position', 'valueCasei' => ['absolute', 'inherit', 'initial', 'relative', 'static']],
                        ['name' => 'quotes'],
                        ['name' => 'resize'],
                        ['name' => 'right'],
                        ['name' => 'tab-size'],
                        ...
                        ['name' => 'word-wrap'],
                        ['name' => 'writing-mode'],
                        ['name' => 'z-index', 'valueRegexCasei' => 'auto|initial|inherit|[-+]?[0-9]+'],
                    ],
                ],
            1 => [
            ...
            2 => ['name' => 'AMP_ONLY_DECLARATIONS', 'declaration' => [['name' => 'clip-path']]],
            3 => [
                    ...
                    'declaration' => [
                        ...
                        ['name' => 'counter-increment'],
                        ['name' => 'counter-reset'],
                        ['name' => 'cursor', 'valueCasei' => ['initial', 'pointer']],
                        ['name' => 'direction'],
                        ['name' => 'display'],
                        ['name' => 'elevation'],
                        ['name' => 'empty-cells'],
                        ...
                        ['name' => 'unicode-bidi'],
                        ['name' => 'vertical-align'],
                        ['name' => 'visibility', 'valueCasei' => ['hidden', 'initial', 'visible']],
                        ['name' => 'voice-family'],
                        ['name' => 'white-space'],
                        ['name' => 'width'],
                        ['name' => 'word-break'],
                        ...
                        ['name' => 'word-wrap'],
                        ['name' => 'writing-mode'],
                        ['name' => 'z-index', 'valueRegexCasei' => '([-+]?0)|([-+]?100)|([-+]?[1-9][0-9]?)'],
                    ],
                ],
        ];
    }
