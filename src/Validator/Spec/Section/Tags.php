...
final class Tags
{
    const TAGS = [
        ...
        'script type=application/ld+json' => 'ScriptTypeApplication/ld+json',
        'script id=amp-rtc' => 'ScriptIdAmpRtc',
        'amp-ima-video > script[type=application/json]' => 'AmpImaVideoScriptTypeApplication/json',
        ...
        'AMP-MEGA-MENU NAV > UL/OL' => 'AmpMegaMenuNavUl/ol',
        'AMP-MEGA-MENU NAV > UL/OL > LI' => 'AmpMegaMenuNavUl/olLi',
        ...
        'SCRIPT type=text/plain' => 'ScriptTypeText/plain',
        'SCRIPT type=text/plain (AMP4EMAIL)' => 'ScriptTypeText/plainAmp4email',
        'TEMPLATE' => 'Template',
        ...
        'AMP-NEXT-PAGE > SCRIPT[type=application/json]' => 'AmpNextPageScriptTypeApplication/json',
