...
| [`AmpStoryCssOptimizer`](https://github.com/ampproject/amp-toolbox-php/blob/main/src/Optimizer/Transformer/AmpStoryCssOptimizer.php) | Enables AMP Story optimizations such as linking to the amp-story-1.0.css, and server side rendering attributes. |
