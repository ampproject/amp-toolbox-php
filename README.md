...
| [`AutoExtensions`](https://github.com/ampproject/amp-toolbox-php/blob/main/src/Optimizer/Transformer/AutoExtensions.php) | Transformer that analyzes the HTML source code, identifies missing AMP extension and automatically imports all the missing AMP extensions. |
